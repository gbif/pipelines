...
public class DataFlowPipelineOptionsTest {
    ...
    public void testWithDefaultTargetDirectoryAndSettingTargetPathsProgrammatically() {
        ...
        interpretationTargetMap.put(Interpretation.RAW_OCCURRENCE, new TargetPath(defaultTargetDirectory, "raw").getFullPath());
        ...
        interpretationTargetMap.put(Interpretation.TEMPORAL, new TargetPath(defaultTargetDirectory, "temporal").getFullPath());
        ...
        interpretationTargetMap.put(Interpretation.LOCATION, new TargetPath(defaultTargetDirectory, "location").getFullPath());
        ...
        interpretationTargetMap.put(Interpretation.INTERPRETED_ISSUE,
                new TargetPath(defaultTargetDirectory, "interpreted").getFullPath());
        interpretationTargetMap.put(Interpretation.TEMP_DwCA_PATH, new TargetPath(defaultTargetDirectory, "temp_file").getFullPath());
