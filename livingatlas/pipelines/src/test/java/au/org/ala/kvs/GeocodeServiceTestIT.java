...
public class GeocodeServiceTestIT {
  ...
  //            .filter(
  //                l ->
  // l.getType().equals(GeocodeShpIntersectService.STATE_PROVINCE_LOCATION_TYPE))
  //            .findFirst();
  ...
  //
  //    GeocodeResponse resp =
  //            geoService.get(LatLng.builder().withLongitude(-145.077283).withLatitude(
  // -38.188337).build());
  ...
  //            geoService.get(
  //
  // LatLng.builder().withLongitude(146.804061).withLatitude(-35.482884).build());
  //    assertFalse(resp.getLocations().isEmpty());
  //  }
  ...
  //            geoService.get(
  //
  // LatLng.builder().withLongitude(151.905301).withLatitude(-30.060141).build());
  //    assertFalse(resp.getLocations().isEmpty());
  //  }
