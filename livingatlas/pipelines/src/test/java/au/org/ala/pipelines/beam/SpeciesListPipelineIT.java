...
import au.org.ala.specieslists.SpeciesList;
...
public class SpeciesListPipelineIT {
    ...
    public void testSpeciesListPipeline() throws Exception {
        ...
        Map<String, TaxonProfile> tps =
                AvroReader.readRecords(null, null, TaxonProfile.class,
        ...
        assertEquals(tps.get("not-an-uuid-1").getConservationStatuses().get(0).getStatus(), "Endangered");
    }
