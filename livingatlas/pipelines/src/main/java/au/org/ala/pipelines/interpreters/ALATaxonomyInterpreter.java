  ...
  public static BiConsumer<ExtendedRecord, ALATaxonRecord> alaTaxonomyInterpreter(
    ...
    return (er, atr) -> {
      if (kvStore != null) {
        ...
        ALASpeciesMatchRequest matchRequest =
            ALASpeciesMatchRequest.builder()
        ...
        if (usageMatch == null || isEmpty(usageMatch)) {
          ...
          // NAME_PARSER.parse(usageMatch.getUsage().getName(),
          //
          ...
          //                            log.warn("Fail to parse backbone {} name for occurrence {}:
          // {}", e.getType(), er.getId(), e.getName());
          //                        }
          //                    }
