...
public class ALANameMatchKVStoreFactory {
    ...
    public static KeyValueStore<NameSearch, NameUsageMatch> getInstance(
     ...
     */
    public static KeyValueStore<NameSearch, NameUsageMatch> create(ALAPipelinesConfig config) throws IOException  {
     ...
     */
    private static KeyValueStore<NameSearch, NameUsageMatch> cache2kBackedKVStore(ALANameMatchService nameMatchService, Command closeHandler, ALAPipelinesConfig config) {

        KeyValueStore kvs = new KeyValueStore<NameSearch, NameUsageMatch>() {
            @Override
        ...
        return KeyValueCache.cache(kvs, config.getAlaNameMatch().getCacheSizeMb(), NameSearch.class, NameUsageMatch.class);
    }
