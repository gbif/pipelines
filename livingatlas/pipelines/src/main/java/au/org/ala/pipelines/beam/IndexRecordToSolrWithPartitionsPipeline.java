...
/**
 * Pipeline that joins sample data and index records and indexes to SOLR. This version of the index
 * record to SOLR pipeline works better on non-EMR environments.
 */
@Slf4j
public class IndexRecordToSolrWithPartitionsPipeline {
