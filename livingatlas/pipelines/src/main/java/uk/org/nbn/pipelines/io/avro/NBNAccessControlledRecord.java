...
public class NBNAccessControlledRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord, Issues, Record {
   ...
   */
  public static BinaryMessageDecoder<NBNAccessControlledRecord> createDecoder(SchemaStore resolver) {
  ...
  public static NBNAccessControlledRecord fromByteBuffer(
   ...
   */
  public NBNAccessControlledRecord(String id, Long created, Boolean accessControlled, String sensitive, String dataGeneralizations, String informationWithheld, String publicResolutionInMetres, java.util.Map<String, String> original, java.util.Map<String, String> altered, org.gbif.pipelines.io.avro.IssueRecord issues) {
    this.id = id;
  ...
  public Object get(int field$) {
    ...
    case 2: return accessControlled;
    case 3: return dataGeneralizations;
    case 4: return informationWithheld;
    case 5: return publicResolutionInMetres;
    case 6: return original;
    case 7: return altered;
    case 8: return issues;
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: created = (Long)value$; break;
    case 2: accessControlled = (java.lang.Boolean)value$; break;
    case 3: dataGeneralizations = (String)value$; break;
    case 4: informationWithheld = (String)value$; break;
    case 5: publicResolutionInMetres = (String)value$; break;
    case 6: original = (java.util.Map<String, String>)value$; break;
    case 7: altered = (java.util.Map<String, String>)value$; break;
    case 8: issues = (org.gbif.pipelines.io.avro.IssueRecord)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  /**
   * Sets the value of the 'isSensitive' field.
   * Does this record have any sensitive data features
   * @param value the value to set.
   */
  ...
  /**
   * Sets the value of the 'generalisationInMetres' field.
   * Coordinate generalisation radius
   * @param value the value to set.
   */
  ...
  /**
   * Sets the value of the 'altered' field.
   * Values that have been altered to meet sensitivity requirements
   * @param value the value to set.
   */
  ...
  /**
   * Creates a new ALASensitivityRecord RecordBuilder by copying an existing ALASensitivityRecord instance.
   ...
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<NBNAccessControlledRecord>
    ...
    private Builder(Builder other) {
      ...
      if (isValidValue(fields()[5], other.publicResolutionInMetres)) {
        this.publicResolutionInMetres = data().deepCopy(fields()[5].schema(), other.publicResolutionInMetres);
    ...
    /**
     * Checks whether the 'isSensitive' field has been set.
     * Does this record have any sensitive data features
    ...
    /**
     * Clears the value of the 'isSensitive' field.
     * Does this record have any sensitive data features
     * @return This builder.
     */
    ...
    /**
      * Checks whether the 'generalisationInMetres' field has been set.
      * Coordinate generalisation radius
    ...
    /**
      * Clears the value of the 'generalisationInMetres' field.
      * Coordinate generalisation radius
      * @return This builder.
      */
    ...
    /**
      * Checks whether the 'altered' field has been set.
      * Values that have been altered to meet sensitivity requirements
    ...
    /**
      * Clears the value of the 'altered' field.
      * Values that have been altered to meet sensitivity requirements
      * @return This builder.
      */
    ...
    public NBNAccessControlledRecord build() {
      try {
        ...
        record.accessControlled = fieldSetFlags()[2] ? this.accessControlled : (Boolean) defaultValue(fields()[2]);
        record.dataGeneralizations = fieldSetFlags()[3] ? this.dataGeneralizations : (String) defaultValue(fields()[3]);
        record.informationWithheld = fieldSetFlags()[4] ? this.informationWithheld : (String) defaultValue(fields()[4]);
        record.publicResolutionInMetres = fieldSetFlags()[5] ? this.publicResolutionInMetres : (String) defaultValue(fields()[5]);
        record.original = fieldSetFlags()[6] ? this.original : (java.util.Map<String, String>) defaultValue(fields()[6]);
        record.altered = fieldSetFlags()[7] ? this.altered : (java.util.Map<String, String>) defaultValue(fields()[7]);
        if (issuesBuilder != null) {
          record.issues = this.issuesBuilder.build();
        } else {
          record.issues = fieldSetFlags()[8] ? this.issues : (org.gbif.pipelines.io.avro.IssueRecord) defaultValue(fields()[8]);
        }
        return record;
      } catch (Exception e) {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<NBNAccessControlledRecord>
    WRITER$ = (org.apache.avro.io.DatumWriter<NBNAccessControlledRecord>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<NBNAccessControlledRecord>
    READER$ = (org.apache.avro.io.DatumReader<NBNAccessControlledRecord>)MODEL$.createDatumReader(SCHEMA$);
