...
public class ExtendedOccurrenceMapper {
  ...
  public static ExtendedOccurrence map(InterpretedExtendedRecord record, Location location, TemporalRecord temporal,
    ...
    ExtendedOccurrence.Builder builder = ExtendedOccurrence.newBuilder()
      .setEarliestEraOrLowestErathem(null)
      .setAssociatedReferences(null)
      .setMeasurementType(null)
      .setKingdom(null)
      .setScientificName(null)
      .setInfraspecificEpithet(null)
      .setIdentificationRemarks(null)
      .setOrganismID(null)
      .setBehavior(null)
      .setSamplingEffort(null)
      .setVernacularName(null)
      .setNamePublishedInID(null)
      .setPhylum(null)
      .setLatestEraOrHighestErathem(null)
      .setResourceRelationshipID(null)
      .setParentNameUsageID(null)
      .setAcceptedNameUsageID(null)
      .setIdentificationQualifier(null)
      .setGeologicalContextID(null)
      .setRelationshipRemarks(null)
      .setOrganismName(null)
      .setMeasurementValue(null)
      .setLatestEpochOrHighestSeries(null)
      .setLithostratigraphicTerms(null)
      .setDisposition(null)
      .setRelatedResourceID(null)
      .setRelationshipAccordingTo(null)
      .setMeasurementDeterminedDate(null)
      .setBed(null)
      .setVerbatimTaxonRank(null)
      .setOccurrenceStatus(null)
      .setFieldNumber(null)
      .setNamePublishedInYear(null)
      .setLatestEonOrHighestEonothem(null)
      .setLatestPeriodOrHighestSystem(null)
      .setAssociatedOccurrences(null)
      .setVerbatimEventDate(null)
      .setSampleSizeUnit(null)
      .setCatalogNumber(null)
      .setNameAccordingToID(null)
      .setRelationshipEstablishedDate(null)
      .setOccurrenceRemarks(null)
      .setGenus(null)
      .setOrder(null)
      .setScientificNameID(null)
      .setEarliestPeriodOrLowestSystem(null)
      .setRelationshipOfResource(null)
      .setIdentificationReferences(null)
      .setFamily(null)
      .setMeasurementMethod(null)
      .setSpecificEpithet(null)
      .setReproductiveCondition(null)
      .setMember(null)
      .setIdentificationVerificationStatus(null)
      .setTaxonRank(null)
      .setFieldNotes(null)
      .setRecordedBy(null)
      .setTaxonomicStatus(null)
      .setOriginalNameUsageID(null)
      .setOrganismRemarks(null)
      .setDateIdentified(null)
      .setOrganismQuantity(null)
      .setPreviousIdentifications(null)
      .setEventID(null)
      .setEarliestEonOrLowestEonothem(null)
      .setMeasurementDeterminedBy(null)
      .setMeasurementRemarks(null)
      .setOrganismQuantityType(null)
      .setEarliestAgeOrLowestStage(null)
      .setMeasurementUnit(null)
      .setSampleSizeValue(null)
      .setGroup(null)
      .setTaxonConceptID(null)
      .setOriginalNameUsage(null)
      .setTaxonRemarks(null)
      .setClass$(null)
      .setOrganismScope(null)
      .setParentNameUsage(null)
      .setSubgenus(null)
      .setLowestBiostratigraphicZone(null)
      .setScientificNameAuthorship(null)
      .setFormation(null)
      .setEarliestEpochOrLowestSeries(null)
      .setAssociatedSequences(null)
      .setLatestAgeOrHighestStage(null)
      .setMaterialSampleID(null)
      .setPreparations(null)
      .setOtherCatalogNumbers(null)
      .setTaxonID(null)
      .setMeasurementID(null)
      .setAcceptedNameUsage(null)
      .setMeasurementAccuracy(null)
      .setRecordNumber(null)
      .setAssociatedTaxa(null)
      .setNameAccordingTo(null)
      .setHigherClassification(null)
      .setAssociatedOrganisms(null)
      .setNomenclaturalCode(null)
      .setEventRemarks(null)
      .setResourceID(null)
      .setHabitat(null)
      .setNamePublishedIn(null)
      .setParentEventID(null)
      .setHighestBiostratigraphicZone(null)
      .setIdentifiedBy(null)
      .setSamplingProtocol(null)
      .setIdentificationID(null)
      .setAssociatedMedia(null)
      .setNomenclaturalStatus(null);
