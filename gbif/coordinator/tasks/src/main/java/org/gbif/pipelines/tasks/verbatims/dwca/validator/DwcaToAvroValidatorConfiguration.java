...
/**
 * Configuration required to convert downloaded DwC archives to avro (ExtendedRecord).
 * Similar to {@link org.gbif.pipelines.tasks.verbatims.dwca.DwcaToAvroConfiguration} but for Pipelines Validator.
 */
@ToString
public class DwcaToAvroValidatorConfiguration implements BaseConfiguration {
  ...
  @NotNull
  public Set<String> interpretTypes = Collections.singleton(InterpretationType.RecordType.ALL.name());

  @Parameter(names = "--file-name")
  @NotNull
  public String fileName = PipelinesVariables.Pipeline.Conversion.FILE_NAME + PipelinesVariables.Pipeline.AVRO_EXTENSION;
