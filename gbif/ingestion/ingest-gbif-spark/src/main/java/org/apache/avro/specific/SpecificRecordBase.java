...
public abstract class SpecificRecordBase
  ...
  private static final long serialVersionUID = 4762949359285092571L;
  ...
  /**
   * Returns true iff an instance supports the {@link MessageEncoder#encode} and {@link
   * MessageDecoder#decode} operations. Should only be used by <code>SpecificDatumReader/Writer
   * </code> to selectively use {@link #customEncode} and {@link #customDecode} to optimize the
