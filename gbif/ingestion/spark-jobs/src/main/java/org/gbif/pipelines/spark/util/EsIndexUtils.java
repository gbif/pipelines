...
public class EsIndexUtils {
  ...
  public static void createIndexAndAliasForDefault(IndexingPipeline.ElasticOptions options) {
  ...
  public static void addIndexAlias(
      EsClient esClient, IndexingPipeline.ElasticOptions options, String indexName) {
  ...
  private static void addIndexAliasForDefault(
      EsClient esClient, IndexingPipeline.ElasticOptions options) {
   ...
   */
  public static Set<String> deleteRecordsByDatasetId(IndexingPipeline.ElasticOptions options) {
    EsConfig config = EsConfig.from(options.getEsHosts());
   ...
   * an update timeout
   */
  public static void refreshIndex(IndexingPipeline.ElasticOptions options) {
