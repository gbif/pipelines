...
public class PathUtil {
  ...
  /**
   * Frictionless datapackage path as stored by the crawler. <br>
   * <b>Format:</b> {base}/{datasetKey}/{datasetKey}.{attempt}
   */
  ...
  /**
   * Pipeline interpreted output path. <br>
   * <b>Format:</b> {base}/{datasetKey}/{attempt}
   */
