...
import org.gbif.pipelines.spark.util.ConvexHullUtil;
...
public class ConvexHullUtilsTest {
  ...
  public void testEmptyCoordinates() {
    Optional<String> result = ConvexHullUtil.calculateGeometry(Set.of());
  ...
  public void testSinglePoint() {
    ...
    Optional<String> result = ConvexHullUtil.calculateGeometry(coords);
