...
public enum EvaluationType {
  ...
  COORDINATE_ACCURACY_INVALID(EvaluationCategory.OCC_INTERPRETATION_BASED),
  COORDINATE_PRECISION_UNCERTAINTY_MISMATCH(EvaluationCategory.OCC_INTERPRETATION_BASED),
  FOOTPRINT_SRS_INVALID(EvaluationCategory.OCC_INTERPRETATION_BASED),
  FOOTPRINT_WKT_MISMATCH(EvaluationCategory.OCC_INTERPRETATION_BASED),
  FOOTPRINT_WKT_INVALID(EvaluationCategory.OCC_INTERPRETATION_BASED),
  INDIVIDUAL_COUNT_CONFLICTS_WITH_OCCURRENCE_STATUS(EvaluationCategory.OCC_INTERPRETATION_BASED),
  OCCURRENCE_STATUS_UNPARSABLE(EvaluationCategory.OCC_INTERPRETATION_BASED),
  OCCURRENCE_STATUS_INFERRED_FROM_INDIVIDUAL_COUNT(EvaluationCategory.OCC_INTERPRETATION_BASED),
  OCCURRENCE_STATUS_INFERRED_FROM_BASIS_OF_RECORD(EvaluationCategory.OCC_INTERPRETATION_BASED),
  GEOREFERENCED_DATE_UNLIKELY(EvaluationCategory.OCC_INTERPRETATION_BASED),
  GEOREFERENCED_DATE_INVALID(EvaluationCategory.OCC_INTERPRETATION_BASED),
  ...
  TAXON_MATCH_SCIENTIFIC_NAME_ID_IGNORED(EvaluationCategory.OCC_INTERPRETATION_BASED),
  TAXON_MATCH_TAXON_CONCEPT_ID_IGNORED(EvaluationCategory.OCC_INTERPRETATION_BASED),
  TAXON_MATCH_TAXON_ID_IGNORED(EvaluationCategory.OCC_INTERPRETATION_BASED),
  TAXON_MATCH_AGGREGATE(EvaluationCategory.OCC_INTERPRETATION_BASED),
  SCIENTIFIC_NAME_ID_NOT_FOUND(EvaluationCategory.OCC_INTERPRETATION_BASED),
  TAXON_CONCEPT_ID_NOT_FOUND(EvaluationCategory.OCC_INTERPRETATION_BASED),
  TAXON_ID_NOT_FOUND(EvaluationCategory.OCC_INTERPRETATION_BASED),
  SCIENTIFIC_NAME_AND_ID_INCONSISTENT(EvaluationCategory.OCC_INTERPRETATION_BASED),
  TAXON_MATCH_NAME_AND_ID_AMBIGUOUS(EvaluationCategory.OCC_INTERPRETATION_BASED),
  ...
  // Paleo
  ERA_OR_ERATHEM_INFERRED_FROM_PARENT_RANK(EvaluationCategory.OCC_INTERPRETATION_BASED),
  PERIOD_OR_SYSTEM_INFERRED_FROM_PARENT_RANK(EvaluationCategory.OCC_INTERPRETATION_BASED),
  EPOCH_OR_SERIES_INFERRED_FROM_PARENT_RANK(EvaluationCategory.OCC_INTERPRETATION_BASED),
  AGE_OR_STAGE_INFERRED_FROM_PARENT_RANK(EvaluationCategory.OCC_INTERPRETATION_BASED),
  EON_OR_EONOTHEM_RANK_MISMATCH(EvaluationCategory.OCC_INTERPRETATION_BASED),
  ERA_OR_ERATHEM_RANK_MISMATCH(EvaluationCategory.OCC_INTERPRETATION_BASED),
  PERIOD_OR_SYSTEM_RANK_MISMATCH(EvaluationCategory.OCC_INTERPRETATION_BASED),
  EPOCH_OR_SERIES_RANK_MISMATCH(EvaluationCategory.OCC_INTERPRETATION_BASED),
  AGE_OR_STAGE_RANK_MISMATCH(EvaluationCategory.OCC_INTERPRETATION_BASED),
  EON_OR_EONOTHEM_INVALID_RANGE(EvaluationCategory.OCC_INTERPRETATION_BASED),
  ERA_OR_ERATHEM_INVALID_RANGE(EvaluationCategory.OCC_INTERPRETATION_BASED),
  PERIOD_OR_SYSTEM_INVALID_RANGE(EvaluationCategory.OCC_INTERPRETATION_BASED),
  EPOCH_OR_SERIES_INVALID_RANGE(EvaluationCategory.OCC_INTERPRETATION_BASED),
  AGE_OR_STAGE_INVALID_RANGE(EvaluationCategory.OCC_INTERPRETATION_BASED),
  EON_OR_EONOTHEM_AND_ERA_OR_ERATHEM_MISMATCH(EvaluationCategory.OCC_INTERPRETATION_BASED),
  ERA_OR_ERATHEM_AND_PERIOD_OR_SYSTEM_MISMATCH(EvaluationCategory.OCC_INTERPRETATION_BASED),
  PERIOD_OR_SYSTEM_AND_EPOCH_OR_SERIES_MISMATCH(EvaluationCategory.OCC_INTERPRETATION_BASED),
  EPOCH_OR_SERIES_AND_AGE_OR_STAGE_MISMATCH(EvaluationCategory.OCC_INTERPRETATION_BASED),
  // Collections
  AMBIGUOUS_INSTITUTION(EvaluationCategory.OCC_INTERPRETATION_BASED),
  AMBIGUOUS_COLLECTION(EvaluationCategory.OCC_INTERPRETATION_BASED),
  INSTITUTION_MATCH_NONE(EvaluationCategory.OCC_INTERPRETATION_BASED),
  COLLECTION_MATCH_NONE(EvaluationCategory.OCC_INTERPRETATION_BASED),
  INSTITUTION_MATCH_FUZZY(EvaluationCategory.OCC_INTERPRETATION_BASED),
  COLLECTION_MATCH_FUZZY(EvaluationCategory.OCC_INTERPRETATION_BASED),
