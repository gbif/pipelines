...
public class InterpretedCategoryTransformerTest {
     ...
     */
        ...
        Coders.registerAvroCodersForKVTypes(p,
                new TupleTag[]{transformer.getTemporalCategory(), transformer.getSpatialCategory(), transformer.getTemporalCategoryIssues(),
     ...
     */
        ...
        PCollectionTuple interpreted_records_transform =
                apply.apply("interpreted records transform", transformer);

        PCollection<KV<String, Event>> events =
                interpreted_records_transform.get(transformer.getTemporalCategory())
                        .setCoder(KvCoder.of(StringUtf8Coder.of(), AvroCoder.of(Event.class)));

        PCollection<KV<String, Location>> spatials =
                interpreted_records_transform.get(transformer.getSpatialCategory())
