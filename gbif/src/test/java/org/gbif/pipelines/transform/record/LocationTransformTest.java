...
public class LocationTransformTest {
  ...
  public void testTransformation() {
    ...
    PCollection<LocationRecord> recordCollection =
        tuple.get(locationTransform.getDataTag()).apply(Kv2Value.create());
    ...
    return Arrays.stream(locations)
        .map(
            x -> {
              ...
              record
                  .getCoreTerms()
                  .put(DwcTerm.minimumDistanceAboveSurfaceInMeters.qualifiedName(), x[9]);
              record
                  .getCoreTerms()
                  .put(DwcTerm.maximumDistanceAboveSurfaceInMeters.qualifiedName(), x[10]);
              record
                  .getCoreTerms()
                  .put(DwcTerm.coordinateUncertaintyInMeters.qualifiedName(), x[11]);
