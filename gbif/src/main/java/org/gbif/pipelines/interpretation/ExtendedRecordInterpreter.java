    ...
    return (ExtendedRecord extendedRecord) ->
      SimpleTypeParser.parseInt(extendedRecord, DwcTerm.individualCount, parseResult -> {
        ...
        if(parseResult.isPresent()) {
          ...
          interpretation.withValidation(Interpretation.Trace.of(OccurrenceIssue.INDIVIDUAL_COUNT_INVALID));
        }
      ...
      VocabularyParsers
        ...
        .map(extendedRecord, parseResult -> {
          ...
          if (parseResult.isSuccessful()) {
            ...
            interpretation.withValidation(Interpretation.Trace.of(OccurrenceIssue.TYPE_STATUS_INVALID));
          }
          return interpretation;
        }).get();
  }
      ...
      VocabularyParsers
        ...
        .map(extendedRecord, parseResult -> {
          ...
          if (parseResult.isSuccessful()) {
            ...
            interpretation.withValidation(Interpretation.Trace.of(OccurrenceIssue.BASIS_OF_RECORD_INVALID));
          }
          return interpretation;
        }).get();
  }
