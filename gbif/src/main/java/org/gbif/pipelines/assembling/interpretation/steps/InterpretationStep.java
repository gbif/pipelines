...
public class InterpretationStep<T> {
  ...
  private final String interpretationType;
  ...
  private static class Builder<T>
    ...
    @Override
    public AvroClassStep<T> interpretationType(String interpretationType) {
  ...
  public interface InterpretationTypeStep<T> {
    AvroClassStep<T> interpretationType(String interpretationType);
  }
