...
public class Templates {
  ...
  public static final String TABLE_CONVERTER =
      "package ${packagePath};\n"
          ...
          + "import ${namespace}.IdentifierRecord;\n"
          ...
          + "   */\n"
          + "  public static Optional<${tableName}> convert(IdentifierRecord ir, ExtendedRecord er) {\n"
          + "    if (er == null || ir == null) {\n"
          + "      return Optional.empty();\n"
          + "    }\n"
          + "    ${tableName} table =\n"
          + "        ${tableName}.newBuilder().setGbifid(Optional.ofNullable(ir.getInternalId()).map(Object::toString).orElse(ir.getId())).build();\n"
          + "\n"
