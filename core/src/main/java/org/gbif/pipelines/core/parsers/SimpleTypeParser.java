...
public class SimpleTypeParser {
  ...
  public static void parseInt(
      ExtendedRecord extendedRecord, DwcTerm term, Consumer<Optional<Integer>> consumer) {
  ...
  public static <U> Optional<U> parseInt(
      ExtendedRecord extendedRecord, DwcTerm term, Function<Optional<Integer>, U> mapper) {
  ...
  public static void parseDouble(
      ExtendedRecord extendedRecord, DwcTerm term, Consumer<Optional<Double>> consumer) {
    Optional.ofNullable(extendedRecord.getCoreTerms().get(term.qualifiedName()))
        .ifPresent(
  ...
  public static <U> Optional<U> parseDouble(
      ExtendedRecord extendedRecord, DwcTerm term, Function<Optional<Double>, U> mapper) {
    return Optional.ofNullable(extendedRecord.getCoreTerms().get(term.qualifiedName()))
  ...
  public static void parseBoolean(
      ExtendedRecord extendedRecord, DwcTerm term, Consumer<ParseResult<Boolean>> consumer) {
    Optional.ofNullable(extendedRecord.getCoreTerms().get(term.qualifiedName()))
  ...
  public static <U> Optional<U> parseBoolean(
      ExtendedRecord extendedRecord, DwcTerm term, Function<ParseResult<Boolean>, U> mapper) {
    return Optional.ofNullable(extendedRecord.getCoreTerms().get(term.qualifiedName()))
