...
public class GBIFInternalWSClientTest extends MockServer {
  ...
  private static final String[] NETWORK_KEY_VAL= new String[]{"7ddd1f14-a2b0-4838-95b0-785846f656f3","e8fbd857-c988-48e5-954f-6e14d0961137"};
  ...
  public void testNetworkResponse() throws IOException {
    ...
    Assert.assertEquals(NETWORK_KEY_VAL[0],response.get(0).getAsJsonObject().getAsJsonPrimitive(NETWORK_KEY).getAsString());
    Assert.assertEquals(NETWORK_KEY_VAL[1],response.get(1).getAsJsonObject().getAsJsonPrimitive(NETWORK_KEY).getAsString());
  }
  ...
  public void testFinalResponse() throws ExecutionException, IOException {
    ...
    Assert.assertEquals(readFile(EOD_INTERNAL_RESPONSE),validatePositive("4fa7b334-ce0d-4e88-aaae-2e0c138d049e"));
  }
