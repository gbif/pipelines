...
public class ExtendedRecordToEventTransformTest {
  ...
  public void valid_test1() throws Exception{
    ...
    List<KV<String, Event>> result = tester.peekOutputElements(ExtendedRecordToEventTransformer.eventDataTag);
    ...
    List<KV<String, IssueLineageRecord>> issueResult = tester.peekOutputElements(ExtendedRecordToEventTransformer.eventIssueTag);
