...
public class ExtendedRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static org.gbif.data.io.avro.ExtendedRecord.Builder newBuilder() {
    return new org.gbif.data.io.avro.ExtendedRecord.Builder();
  }
  
  /** Creates a new ExtendedRecord RecordBuilder by copying an existing Builder */
  public static org.gbif.data.io.avro.ExtendedRecord.Builder newBuilder(org.gbif.data.io.avro.ExtendedRecord.Builder other) {
    return new org.gbif.data.io.avro.ExtendedRecord.Builder(other);
  }
  
  /** Creates a new ExtendedRecord RecordBuilder by copying an existing ExtendedRecord instance */
  public static org.gbif.data.io.avro.ExtendedRecord.Builder newBuilder(org.gbif.data.io.avro.ExtendedRecord other) {
    return new org.gbif.data.io.avro.ExtendedRecord.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ExtendedRecord>
    ...
    private Builder() {
      super(org.gbif.data.io.avro.ExtendedRecord.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.gbif.data.io.avro.ExtendedRecord.Builder other) {
      super(other);
    ...
    private Builder(org.gbif.data.io.avro.ExtendedRecord other) {
            super(org.gbif.data.io.avro.ExtendedRecord.SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'id' field */
    public org.gbif.data.io.avro.ExtendedRecord.Builder setId(java.lang.CharSequence value) {
    ...
    public org.gbif.data.io.avro.ExtendedRecord.Builder clearId() {
      id = null;
    ...
    /** Sets the value of the 'coreTerms' field */
    public org.gbif.data.io.avro.ExtendedRecord.Builder setCoreTerms(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    public org.gbif.data.io.avro.ExtendedRecord.Builder clearCoreTerms() {
      coreTerms = null;
    ...
    /** Sets the value of the 'extensions' field */
    public org.gbif.data.io.avro.ExtendedRecord.Builder setExtensions(java.util.Map<java.lang.CharSequence,java.util.List<java.util.Map<java.lang.CharSequence,java.lang.CharSequence>>> value) {
    ...
    public org.gbif.data.io.avro.ExtendedRecord.Builder clearExtensions() {
      extensions = null;
