...
public class GeocodeStoreFactory {
  ...
  private static KeyValueStore<LatLng, GeocodeResponse> instance;

  public static synchronized KeyValueStore<LatLng, GeocodeResponse> createSingleton(KvConfig config) {
    if (instance == null) {
