...
public class FileSystems {
   ...
   *
   * <p>If replaceExisting is enabled and filesystem throws {code FileAlreadyExistsException} then an
   * attempt to delete the destination is made and the rename is retried. Some filesystem implementations
   * may apply this automatically without throwing.
   *
  ...
  @VisibleForTesting
  static void rename(
      FileSystem fileSystem, List<ResourceId> src, List<ResourceId> dest, boolean replaceExisting)
      throws IOException {
    try {
