...
@Builder
public class GelImageTableTransform implements Serializable {

  @NonNull private final TupleTag<ExtendedRecord> extendedRecordTag;
  @NonNull private final TupleTag<BasicRecord> basicRecordTag;

  public ParDo.SingleOutput<KV<String, CoGbkResult>, GelImageTable> converter() {
    DoFn<KV<String, CoGbkResult>, GelImageTable> fn =
        new DoFn<KV<String, CoGbkResult>, GelImageTable>() {

          private final Counter counter =
              Metrics.counter(GelImageTableTransform.class, GEL_IMAGE_TABLE_RECORDS_COUNT);
          ...
          public void processElement(ProcessContext c) {
            ...
            GelImageTableConverter.convert(br, er)
                .ifPresent(
                    record -> {
                      c.output(record);
                      counter.inc();
  ...
  public AvroIO.Write<GelImageTable> write(String toPath, Integer numShards) {
    AvroIO.Write<GelImageTable> write =
        AvroIO.write(GelImageTable.class)
            .to(toPath)
