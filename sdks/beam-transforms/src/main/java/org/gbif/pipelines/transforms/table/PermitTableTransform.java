...
@Builder
public class PermitTableTransform implements Serializable {

  @NonNull private final TupleTag<ExtendedRecord> extendedRecordTag;
  @NonNull private final TupleTag<BasicRecord> basicRecordTag;

  public ParDo.SingleOutput<KV<String, CoGbkResult>, PermitTable> converter() {
    DoFn<KV<String, CoGbkResult>, PermitTable> fn =
        new DoFn<KV<String, CoGbkResult>, PermitTable>() {

          private final Counter counter =
              Metrics.counter(PermitTableTransform.class, PERMIT_TABLE_RECORDS_COUNT);
          ...
          public void processElement(ProcessContext c) {
            ...
            PermitTableConverter.convert(br, er)
                .ifPresent(
                    record -> {
                      c.output(record);
                      counter.inc();
  ...
  public AvroIO.Write<PermitTable> write(String toPath, Integer numShards) {
    AvroIO.Write<PermitTable> write =
        AvroIO.write(PermitTable.class)
            .to(toPath)
