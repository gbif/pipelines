...
@Builder
public class ResourceRelationshipTableTransform implements Serializable {

  @NonNull private final TupleTag<ExtendedRecord> extendedRecordTag;
  @NonNull private final TupleTag<BasicRecord> basicRecordTag;

  public ParDo.SingleOutput<KV<String, CoGbkResult>, ResourceRelationshipTable> converter() {
    DoFn<KV<String, CoGbkResult>, ResourceRelationshipTable> fn =
        new DoFn<KV<String, CoGbkResult>, ResourceRelationshipTable>() {

          private final Counter counter =
              Metrics.counter(
                  ResourceRelationshipTableTransform.class, RESOURCE_RELATION_TABLE_RECORDS_COUNT);
          ...
          public void processElement(ProcessContext c) {
            ...
            ResourceRelationshipTableConverter.convert(br, er)
                .ifPresent(
                    record -> {
                      c.output(record);
                      counter.inc();
  ...
  public AvroIO.Write<ResourceRelationshipTable> write(String toPath, Integer numShards) {
    AvroIO.Write<ResourceRelationshipTable> write =
        AvroIO.write(ResourceRelationshipTable.class)
            .to(toPath)
