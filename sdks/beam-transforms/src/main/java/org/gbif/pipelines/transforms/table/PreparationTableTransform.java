...
@Builder
public class PreparationTableTransform implements Serializable {

  @NonNull private final TupleTag<ExtendedRecord> extendedRecordTag;
  @NonNull private final TupleTag<BasicRecord> basicRecordTag;

  public ParDo.SingleOutput<KV<String, CoGbkResult>, PreparationTable> converter() {
    DoFn<KV<String, CoGbkResult>, PreparationTable> fn =
        new DoFn<KV<String, CoGbkResult>, PreparationTable>() {

          private final Counter counter =
              Metrics.counter(PreparationTableTransform.class, PREPARATION_TABLE_RECORDS_COUNT);
          ...
          public void processElement(ProcessContext c) {
            ...
            PreparationTableConverter.convert(br, er)
                .ifPresent(
                    record -> {
                      c.output(record);
                      counter.inc();
  ...
  public AvroIO.Write<PreparationTable> write(String toPath, Integer numShards) {
    AvroIO.Write<PreparationTable> write =
        AvroIO.write(PreparationTable.class)
            .to(toPath)
