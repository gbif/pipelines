...
@Builder
public class GermplasmMeasurementTraitTableTransform implements Serializable {

  @NonNull private final TupleTag<ExtendedRecord> extendedRecordTag;
  @NonNull private final TupleTag<BasicRecord> basicRecordTag;

  public ParDo.SingleOutput<KV<String, CoGbkResult>, GermplasmMeasurementTraitTable> converter() {
    DoFn<KV<String, CoGbkResult>, GermplasmMeasurementTraitTable> fn =
        new DoFn<KV<String, CoGbkResult>, GermplasmMeasurementTraitTable>() {

          private final Counter counter =
              Metrics.counter(
                  GermplasmMeasurementTraitTableTransform.class,
          ...
          public void processElement(ProcessContext c) {
            ...
            GermplasmMeasurementTraitTableConverter.convert(br, er)
                .ifPresent(
                    record -> {
                      c.output(record);
                      counter.inc();
  ...
  public AvroIO.Write<GermplasmMeasurementTraitTable> write(String toPath, Integer numShards) {
    AvroIO.Write<GermplasmMeasurementTraitTable> write =
        AvroIO.write(GermplasmMeasurementTraitTable.class)
            .to(toPath)
