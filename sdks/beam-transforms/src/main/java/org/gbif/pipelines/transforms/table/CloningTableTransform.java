...
@Builder
public class CloningTableTransform implements Serializable {

  @NonNull private final TupleTag<ExtendedRecord> extendedRecordTag;
  @NonNull private final TupleTag<BasicRecord> basicRecordTag;

  public ParDo.SingleOutput<KV<String, CoGbkResult>, CloningTable> converter() {
    DoFn<KV<String, CoGbkResult>, CloningTable> fn =
        new DoFn<KV<String, CoGbkResult>, CloningTable>() {

          private final Counter counter =
              Metrics.counter(CloningTableTransform.class, CLONING_TABLE_RECORDS_COUNT);
          ...
          public void processElement(ProcessContext c) {
            ...
            CloningTableConverter.convert(br, er)
                .ifPresent(
                    record -> {
                      c.output(record);
                      counter.inc();
  ...
  public AvroIO.Write<CloningTable> write(String toPath, Integer numShards) {
    AvroIO.Write<CloningTable> write =
        AvroIO.write(CloningTable.class)
            .to(toPath)
