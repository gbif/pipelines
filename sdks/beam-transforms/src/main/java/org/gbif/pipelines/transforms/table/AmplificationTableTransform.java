...
@Builder
public class AmplificationTableTransform implements Serializable {

  @NonNull private final TupleTag<ExtendedRecord> extendedRecordTag;
  @NonNull private final TupleTag<BasicRecord> basicRecordTag;

  public ParDo.SingleOutput<KV<String, CoGbkResult>, AmplificationTable> converter() {
    DoFn<KV<String, CoGbkResult>, AmplificationTable> fn =
        new DoFn<KV<String, CoGbkResult>, AmplificationTable>() {

          private final Counter counter =
              Metrics.counter(AmplificationTableTransform.class, AMPLIFICATION_TABLE_RECORDS_COUNT);
          ...
          public void processElement(ProcessContext c) {
            ...
            AmplificationTableConverter.convert(br, er)
                .ifPresent(
                    record -> {
                      c.output(record);
                      counter.inc();
  ...
  public AvroIO.Write<AmplificationTable> write(String toPath, Integer numShards) {
    AvroIO.Write<AmplificationTable> write =
        AvroIO.write(AmplificationTable.class)
            .to(toPath)
