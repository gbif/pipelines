...
public class DeprecatedTemporalParserTest {
  ...
  public void allNullTest() {
    ...
    // When
    ParsedTemporal result = DeprecatedTemporalParser.parse(year, month, day, eventDate);
  ...
  public void wrongLeapDay2Test() {
    ...
    // When
    ParsedTemporal result = DeprecatedTemporalParser.parse(year, month, day, null);
