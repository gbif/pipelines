...
public class GbifJsonConverterTest {
  ...
  public void jsonFromSpecificRecordBaseTest() throws IOException {
    ...
    Assert.assertEquals(expected, sorted(result));
  }
  ...
  public void onlyOneIdInJsonTest() throws IOException {
    ...
    // Expected
    String expected =
       "{id=777, all=[], verbatim={core={}, extensions={}}, issues=[], notIssues=[AMBIGUOUS_COLLECTION, AMBIGUOUS_INSTITUTION, BASIS_OF_RECORD_INVALID, COLLECTION_MATCH_FUZZY, COLLECTION_MATCH_NONE, CONTINENT_COUNTRY_MISMATCH, CONTINENT_DERIVED_FROM_COORDINATES, CONTINENT_INVALID, COORDINATE_ACCURACY_INVALID, COORDINATE_INVALID, COORDINATE_OUT_OF_RANGE, COORDINATE_PRECISION_INVALID, COORDINATE_PRECISION_UNCERTAINTY_MISMATCH, COORDINATE_REPROJECTED, COORDINATE_REPROJECTION_FAILED, COORDINATE_REPROJECTION_SUSPICIOUS, COORDINATE_ROUNDED, COORDINATE_UNCERTAINTY_METERS_INVALID, COUNTRY_COORDINATE_MISMATCH, COUNTRY_DERIVED_FROM_COORDINATES, COUNTRY_INVALID, COUNTRY_MISMATCH, DEPTH_MIN_MAX_SWAPPED, DEPTH_NON_NUMERIC, DEPTH_NOT_METRIC, DEPTH_UNLIKELY, ELEVATION_MIN_MAX_SWAPPED, ELEVATION_NON_NUMERIC, ELEVATION_NOT_METRIC, ELEVATION_UNLIKELY, GEODETIC_DATUM_ASSUMED_WGS84, GEODETIC_DATUM_INVALID, GEOREFERENCED_DATE_INVALID, GEOREFERENCED_DATE_UNLIKELY, IDENTIFIED_DATE_INVALID, IDENTIFIED_DATE_UNLIKELY, INDIVIDUAL_COUNT_CONFLICTS_WITH_OCCURRENCE_STATUS, INDIVIDUAL_COUNT_INVALID, INSTITUTION_COLLECTION_MISMATCH, INSTITUTION_MATCH_FUZZY, INSTITUTION_MATCH_NONE, INTERPRETATION_ERROR, MODIFIED_DATE_INVALID, MODIFIED_DATE_UNLIKELY, MULTIMEDIA_DATE_INVALID, MULTIMEDIA_URI_INVALID, OCCURRENCE_STATUS_INFERRED_FROM_INDIVIDUAL_COUNT, OCCURRENCE_STATUS_UNPARSABLE, POSSIBLY_ON_LOAN, PRESUMED_NEGATED_LATITUDE, PRESUMED_NEGATED_LONGITUDE, PRESUMED_SWAPPED_COORDINATE, RECORDED_DATE_INVALID, RECORDED_DATE_MISMATCH, RECORDED_DATE_UNLIKELY, REFERENCES_URI_INVALID, TAXON_MATCH_FUZZY, TAXON_MATCH_HIGHERRANK, TAXON_MATCH_NONE, TYPE_STATUS_INVALID, ZERO_COORDINATE]}";
    // State
  ...
  public void emptyAvroWithIdTest() throws IOException {
    // Expected
    String expected =
        "{datasetKey=key, crawlId=1, license=l, datasetPublishingCountry=PC, issues=[], gbifClassification={}, measurementOrFactItems=[], id=777, all=[], verbatim={core={}, extensions={}}, notIssues=[AMBIGUOUS_COLLECTION, AMBIGUOUS_INSTITUTION, BASIS_OF_RECORD_INVALID, COLLECTION_MATCH_FUZZY, COLLECTION_MATCH_NONE, CONTINENT_COUNTRY_MISMATCH, CONTINENT_DERIVED_FROM_COORDINATES, CONTINENT_INVALID, COORDINATE_ACCURACY_INVALID, COORDINATE_INVALID, COORDINATE_OUT_OF_RANGE, COORDINATE_PRECISION_INVALID, COORDINATE_PRECISION_UNCERTAINTY_MISMATCH, COORDINATE_REPROJECTED, COORDINATE_REPROJECTION_FAILED, COORDINATE_REPROJECTION_SUSPICIOUS, COORDINATE_ROUNDED, COORDINATE_UNCERTAINTY_METERS_INVALID, COUNTRY_COORDINATE_MISMATCH, COUNTRY_DERIVED_FROM_COORDINATES, COUNTRY_INVALID, COUNTRY_MISMATCH, DEPTH_MIN_MAX_SWAPPED, DEPTH_NON_NUMERIC, DEPTH_NOT_METRIC, DEPTH_UNLIKELY, ELEVATION_MIN_MAX_SWAPPED, ELEVATION_NON_NUMERIC, ELEVATION_NOT_METRIC, ELEVATION_UNLIKELY, GEODETIC_DATUM_ASSUMED_WGS84, GEODETIC_DATUM_INVALID, GEOREFERENCED_DATE_INVALID, GEOREFERENCED_DATE_UNLIKELY, IDENTIFIED_DATE_INVALID, IDENTIFIED_DATE_UNLIKELY, INDIVIDUAL_COUNT_CONFLICTS_WITH_OCCURRENCE_STATUS, INDIVIDUAL_COUNT_INVALID, INSTITUTION_COLLECTION_MISMATCH, INSTITUTION_MATCH_FUZZY, INSTITUTION_MATCH_NONE, INTERPRETATION_ERROR, MODIFIED_DATE_INVALID, MODIFIED_DATE_UNLIKELY, MULTIMEDIA_DATE_INVALID, MULTIMEDIA_URI_INVALID, OCCURRENCE_STATUS_INFERRED_FROM_INDIVIDUAL_COUNT, OCCURRENCE_STATUS_UNPARSABLE, POSSIBLY_ON_LOAN, PRESUMED_NEGATED_LATITUDE, PRESUMED_NEGATED_LONGITUDE, PRESUMED_SWAPPED_COORDINATE, RECORDED_DATE_INVALID, RECORDED_DATE_MISMATCH, RECORDED_DATE_UNLIKELY, REFERENCES_URI_INVALID, TAXON_MATCH_FUZZY, TAXON_MATCH_HIGHERRANK, TAXON_MATCH_NONE, TYPE_STATUS_INVALID, ZERO_COORDINATE]}";
    // State
    String k = "777";
    MetadataRecord mdr =
        MetadataRecord.newBuilder()
