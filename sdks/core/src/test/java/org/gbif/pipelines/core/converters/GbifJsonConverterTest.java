  ...
  public void jsonFromSpecificRecordBaseTest() {
    ...
    String expected =
        "{\"datasetKey\":\"datatesKey\",\"crawlId\":1,\"license\":\"CC_BY_NC_4_0\",\"issues\":[\"BASIS_OF_RECORD_INVALID\","
            + "\"ZERO_COORDINATE\"],\"id\":\"777\",\"recordedBy\":\"Jeremia garde ,à elfutsone\",\"identifiedBy\":\"D2 R2\","
            + "\"all\":[\"Jeremia garde ,à elfutsone\",\"{\\\"something\\\":1}{\\\"something\\\":1}\",\"D2 R2\","
            + "\"something:{something}\"],\"verbatim\":{\"core\":{\"http://rs.tdwg.org/dwc/terms/identifiedBy\":\"D2 R2\","
            ...
            + "\"eventDateSingle\":\"01-01-2011\",\"year\":2011,\"month\":1,\"day\":1,\"eventDate\":{\"gte\":\"01-01-2011\","
            + "\"lte\":\"01-01-2018\"},\"startDayOfYear\":1,\"coordinates\":{\"lon\":2.0,\"lat\":1.0},\"decimalLatitude\":1.0,"
            + "\"decimalLongitude\":2.0,\"scoordinates\":\"POINT (2.0 1.0)\",\"continent\":\"something{something}\","
            + "\"country\":\"Country\",\"countryCode\":\"Code 1'2\\\"\",\"locality\":\"[68]\",\"gbifClassification\""
            + ":{\"usage\":{\"key\":10,\"name\":\"synonym\",\"rank\":\"SPECIES\"},\"classification\":[{\"key\":1,\"name\":"
            + "\"Name\",\"rank\":\"CHEMOFORM\"},{\"key\":2,\"name\":\"Name2\",\"rank\":\"ABERRATION\"}],\"acceptedUsage\""
            + ":{\"key\":11,\"name\":\"accepted usage\",\"rank\":\"SPECIES\"},\"chemoformKey\":1,\"chemoform\":\"Name\","
            + "\"aberrationKey\":2,\"aberration\":\"Name2\",\"classificationPath\":\"_1_2\",\"taxonKey\":[1,2,10,11]},"
            + "\"gbifId\":111,\"sampleSizeValue\":2.0,\"sampleSizeUnit\":\"SampleSizeUnit\",\"organismQuantity\":2.0,"
            + "\"organismQuantityType\":\"OrganismQuantityType\",\"relativeOrganismQuantity\":0.001,\"identifiedByIds"
            + "\":[{\"type\":\"OTHER\",\"value\":\"someId\"}],\"recordedByIds\":[{\"type\":\"OTHER\",\"value\":\"someId\"}],"
            + "\"occurrenceStatus\":\"PRESENT\",\"collectionKey\":\"75956ee6-1a2b-4fa3-b3e8-ccda64ce6c2d\",\"institutionKey"
            ...
            + "\"TYPE_STATUS_INVALID\",\"TAXON_MATCH_FUZZY\",\"CONTINENT_INVALID\",\"MODIFIED_DATE_UNLIKELY\","
            + "\"COORDINATE_ROUNDED\",\"IDENTIFIED_DATE_UNLIKELY\",\"COUNTRY_DERIVED_FROM_COORDINATES\","
            + "\"COORDINATE_REPROJECTION_FAILED\",\"MULTIMEDIA_URI_INVALID\",\"GEODETIC_DATUM_ASSUMED_WGS84\","
            + "\"ELEVATION_UNLIKELY\",\"INDIVIDUAL_COUNT_INVALID\",\"RECORDED_DATE_MISMATCH\",\"INDIVIDUAL_COUNT_UNPARSABLE\","
            + "\"COUNTRY_MISMATCH\",\"CONTINENT_COUNTRY_MISMATCH\",\"OCCURRENCE_STATUS_UNPARSABLE\",\"COORDINATE_OUT_OF_RANGE\","
            ...
            + "\"PRESUMED_SWAPPED_COORDINATE\",\"REFERENCES_URI_INVALID\",\"COUNTRY_COORDINATE_MISMATCH\",\"DEPTH_NON_NUMERIC\","
            + "\"COORDINATE_UNCERTAINTY_METERS_INVALID\",\"PRESUMED_NEGATED_LATITUDE\",\"COORDINATE_ACCURACY_INVALID\","
            + "\"TAXON_MATCH_HIGHERRANK\",\"CONTINENT_DERIVED_FROM_COORDINATES\",\"DEPTH_MIN_MAX_SWAPPED\","
            + "\"RECORDED_DATE_INVALID\",\"DEPTH_NOT_METRIC\",\"MULTIMEDIA_DATE_INVALID\",\"INTERPRETATION_ERROR\","
  ...
  public void jsonFromSpecificRecordBaseAustraliaTest() {
    ...
    String expected =
        "{\"id\":\"777\",\"all\":[\"Cr1\",\"{\\\"something\\\":1}{\\\"something\\\":1}\",\"http://www.gbif.org/tmp.jpg\","
            ...
            + "\"RECORDED_DATE_MISMATCH\",\"INDIVIDUAL_COUNT_UNPARSABLE\",\"COUNTRY_MISMATCH\",\"CONTINENT_COUNTRY_MISMATCH\","
  ...
  public void onlyOneIdInJsonTest() {
    ...
    String expected =
        "{\"id\":\"777\",\"all\":[],\"verbatim\":{\"core\":{},\"extensions\":{}},\"issues\":[],"
            ...
            + "\"RECORDED_DATE_MISMATCH\",\"INDIVIDUAL_COUNT_UNPARSABLE\",\"ZERO_COORDINATE\",\"COUNTRY_MISMATCH\","
