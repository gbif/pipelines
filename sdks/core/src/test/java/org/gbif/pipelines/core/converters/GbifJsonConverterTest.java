...
public class GbifJsonConverterTest {
  ...
  @Test
  public void testJsonFromSpecificRecordBaseAustralia() {
    ...
    String expected =
        "{\"id\":\"777\",\"verbatim\":{\"remark\":\"{\\\"something\\\":1}{\\\"something\\\":1}\",\"locality\":\"something:{something}\"},"
            ...
            + "\"continent\":\"something{something}\",\"countryCode\":\"Code 1'2\\\"\",\"backbone\":[{\"taxonKey\":1,\"name\":\"Name\","
            + "\"depthKey_0\":1,\"kingdomKey\":1,\"rank\":\"CHEMOFORM\"},{\"taxonKey\":2,\"name\":\"Name2\",\"depthKey_1\":2,"
            + "\"kingdomKey\":2,\"rank\":\"ABERRATION\"}],\"australiaSpatial\":{\"field\":\"Some data\"},\"notIssues\":"
            ...
            + "\"DEPTH_MIN_MAX_SWAPPED\",\"RECORDED_DATE_INVALID\",\"INDIVIDUAL_COUNT_INVALID\",\"RECORDED_DATE_MISMATCH\",\"DEPTH_NOT_METRIC\","
