...
public class AudubonInterpreterTest {
  ...
  public void audubonTest() {
    ...
    String expected = "{\"id\": \"id\", \"created\": null, \"audubonItems\": [{\"creator\": \"Jose Padial\", "
        ...
        + "\"createDate\": null, \"timeOfDay\": null}], \"issues\": {\"issueList\": []}}";

    // State
    Map<String, List<Map<String, String>>> ext = new HashMap<>(1);
    Map<String, String> audubon = new HashMap<>(15);
    ...
    audubon.put("http://rs.tdwg.org/ac/terms/accessURI", "https://api.idigbio.org/v2/media/414560e3c8514266b6d9e1888a792564");
    audubon.put("http://ns.adobe.com/xap/1.0/rights/Owner", "Carnegie Museum of Natural History Herps Collection (CM:Herps)");
