...
public class LengthParserTest {
  ...
  public void parser11Test() {
    ...
    // Should
    Assert.assertTrue(result.isPresent());
    Assert.assertEquals("Body length", result.get().getKey());
  ...
  public void parser12Test() {
    ...
    // Should
    Assert.assertTrue(result.isPresent());
    Assert.assertEquals("t.l.", result.get().getKey());
  ...
  public void parser16Test() {
    ...
    // Should
    Assert.assertTrue(result.isPresent());
    Assert.assertEquals("length", result.get().getKey());
    Assert.assertEquals("mm", result.get().getType());
  ...
  public void parser18Test() {
    ...
    // Should
    Assert.assertTrue(result.isPresent());
    Assert.assertEquals("TL_", result.get().getKey());
  ...
  public void parser19Test() {
    ...
    // Should
    Assert.assertTrue(result.isPresent());
    Assert.assertEquals("TL", result.get().getKey());
    Assert.assertEquals("mm", result.get().getType());
  ...
  public void parser22Test() {
    ...
    // Should
    Assert.assertTrue(result.isPresent());
    Assert.assertEquals("Snout vent lengths", result.get().getKey());
    Assert.assertEquals("mm.", result.get().getType());
  ...
  public void parser25Test() {
    ...
    // Should
    Assert.assertTrue(result.isPresent());
    Assert.assertEquals("SVL", result.get().getKey());
    Assert.assertEquals("mm", result.get().getType());
  ...
  public void parser27Test() {
    ...
    // Should
    Assert.assertTrue(result.isPresent());
    Assert.assertEquals("total", result.get().getKey());
    Assert.assertEquals("mm", result.get().getType());
  ...
  public void parser31Test() {
    ...
    // Should
    Assert.assertTrue(result.isPresent());
    Assert.assertEquals("totalLengthInMM", result.get().getKey());
    Assert.assertEquals("MM", result.get().getType());
  ...
  public void parser41Test() {
    ...
    // Should
    Assert.assertTrue(result.isPresent());
    Assert.assertEquals("SL", result.get().getKey());
    Assert.assertEquals("mm", result.get().getType());
  ...
  public void parser47Test() {
    ...
    // Should
    Assert.assertTrue(result.isPresent());
    Assert.assertEquals("LABEL. LENGTH", result.get().getKey());
    Assert.assertEquals("MM.", result.get().getType());
  ...
  public void parser50Test() {
    ...
    // Should
    Assert.assertTrue(result.isPresent());
    Assert.assertEquals("SV", result.get().getKey());
    Assert.assertNull(result.get().getType());
  ...
  public void parser53Test() {
    ...
    // Should
    Assert.assertTrue(result.isPresent());
    Assert.assertEquals("Measurements: L", result.get().getKey());
    Assert.assertEquals("cm", result.get().getType());
    Assert.assertEquals("21.0", result.get().getValue());
    Assert.assertEquals("String", result.get().getClazz());
  }
